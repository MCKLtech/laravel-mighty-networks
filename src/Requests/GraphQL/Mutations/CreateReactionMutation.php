...
/**
 * `mutation { createReaction(input: $input) { ... } }`.
 */
final class CreateReactionMutation extends AbstractTypedMutation
{
    public function __construct(
        int|string $networkIdOrSubdomain,
        private readonly CreateReactionInput $input,
    ...
    {
        return GraphQLMutation::CreateReaction;
    }
    ...
    {
        return MutationSelections::payload('reaction', MutationSelections::reaction());
    }
}
