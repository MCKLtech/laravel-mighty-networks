...
/**
 * `mutation { updateWebhookCallback(input: $input) { ... } }`.
 */
final class UpdateWebhookCallbackMutation extends AbstractTypedMutation
{
    public function __construct(
        int|string $networkIdOrSubdomain,
        private readonly UpdateWebhookCallbackInput $input,
    ...
    {
        return GraphQLMutation::UpdateWebhookCallback;
    }
