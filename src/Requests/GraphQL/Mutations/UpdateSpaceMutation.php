...
/**
 * `mutation { updateSpace(input: $input) { ... } }`.
 */
final class UpdateSpaceMutation extends AbstractTypedMutation
{
    public function __construct(
        int|string $networkIdOrSubdomain,
        private readonly UpdateSpaceInput $input,
    ...
    {
        return GraphQLMutation::UpdateSpace;
    }
    ...
    {
        return MutationSelections::payload('space', MutationSelections::space());
    }
}
