...
/**
 * `mutation { deleteMember(input: $input) { ... } }`.
 */
final class DeleteMemberMutation extends AbstractTypedMutation
{
    public function __construct(
        int|string $networkIdOrSubdomain,
        private readonly DeleteMemberInput $input,
    ...
    {
        return GraphQLMutation::DeleteMember;
    }
