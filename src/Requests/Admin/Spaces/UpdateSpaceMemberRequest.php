...
/**
 * `PATCH networks/{network_id}/spaces/{space_id}/members/{user_id}/`
 *
 * Updates a member's role (and optionally profile fields) within the space.
 */
final class UpdateSpaceMemberRequest extends AdminRequest implements HasBody
{
    use HasJsonBody;
