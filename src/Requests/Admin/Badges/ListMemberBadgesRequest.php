...
/**
 * `GET networks/{network_id}/members/{member_id}/badges`
 *
 * Paginated: `page` (default 1) and `per_page` (default 25, max 100).
 */
final class ListMemberBadgesRequest extends AdminRequest implements MapPaginatedResponseItems, Paginatable
{
