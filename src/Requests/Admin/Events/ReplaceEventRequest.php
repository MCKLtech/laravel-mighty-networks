...
/**
 * `PUT networks/{network_id}/events/{id}/`
 *
 * Replaces the event with the supplied representation.
 */
final class ReplaceEventRequest extends AdminRequest implements HasBody
{
    use HasJsonBody;
