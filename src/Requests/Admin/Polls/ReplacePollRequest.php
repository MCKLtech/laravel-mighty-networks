...
/**
 * `PUT networks/{network_id}/polls/{id}/`
 *
 * Replaces the poll with the supplied representation.
 */
final class ReplacePollRequest extends AdminRequest implements HasBody
{
    use HasJsonBody;
    ...
    public function __construct(
        ...
        protected readonly UpdatePollData $data,
    ) {
