...
/**
 * `GET networks/{network_id}/comments/{comment_id}/reactions`
 *
 * Paginated: `page` (default 1) and `per_page` (default 25, max 100).
 */
final class ListCommentReactionsRequest extends AdminRequest implements MapPaginatedResponseItems, Paginatable
{
