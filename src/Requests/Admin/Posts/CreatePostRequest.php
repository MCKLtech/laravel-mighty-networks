 ...
 *
 * The optional `notify` query parameter controls whether the Network is
 * notified about the new post.
 */
final class CreatePostRequest extends AdminRequest implements HasBody
{
    use HasJsonBody;
    ...
    public function __construct(
        ...
        protected readonly NewPostData $data,
