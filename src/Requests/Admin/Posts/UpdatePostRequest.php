...
/**
 * `PATCH networks/{network_id}/posts/{id}/`
 *
 * A partial update. The optional `notify` query parameter controls whether the
 * Network is notified about the change.
 */
final class UpdatePostRequest extends AdminRequest implements HasBody
{
    use HasJsonBody;
