...
/**
 * `GET networks/{network_id}/members/{member_id}/plans`
 *
 * Paginated: `page` (default 1) and `per_page` (default 25, max 100).
 * Note the spec documents this path without a trailing slash.
 */
final class ListMemberPlansRequest extends AdminRequest implements MapPaginatedResponseItems, Paginatable
{
    ...
    {
        return $this->networkEndpoint(sprintf('members/%d/plans', $this->memberId));
    }
